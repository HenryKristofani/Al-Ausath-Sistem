...
Folder ini berisi contoh request per endpoint untuk modul akademik yang dipakai FE.

Daftar file:

- bobot-nilai-get.md
- bobot-nilai-post.md
- bobot-nilai-set-default.md
- bobot-nilai-show.md
- bobot-nilai-put.md
- bobot-nilai-delete.md
- kkm-mapel-get.md
- kkm-mapel-post.md
- kkm-mapel-show.md
- kkm-mapel-put.md
- kkm-mapel-delete.md
- konversi-nilai-get.md
- konversi-nilai-post.md
- konversi-nilai-show.md
- konversi-nilai-put.md
...
- kelas-import.md
- kelas-export.md
- kelas-import-template.md
- kelas-dependency-summary.md
- kelas-restore.md
- kelas-force-delete.md
- kelas-show.md
- kelas-put.md
- kelas-delete.md
